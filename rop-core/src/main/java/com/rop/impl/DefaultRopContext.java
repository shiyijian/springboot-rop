...
public class DefaultRopContext implements RopContext {
    ...
    private ServiceMethodDefinition buildServiceMethodDefinition(ServiceMethod serviceMethod) {
        ...
        definition.setNeedSessionToken(NeedSessionTokenType.isNeedSessionToken(serviceMethod.needSessionToken()));
    ...
    private ServiceMethodDefinition buildServiceMethodDefinition(ServiceMethodBean serviceMethodBean, ServiceMethod serviceMethod) {
        ...
        definition.setNeedSessionToken(NeedSessionTokenType.isNeedSessionToken(serviceMethodBean.needSessionToken()));
        ...
        if(serviceMethod.needSessionToken() != NeedSessionTokenType.DEFAULT){
            definition.setNeedSessionToken(NeedSessionTokenType.isNeedSessionToken(serviceMethod.needSessionToken()));
        }
