...
public class SimpleRopRequestContext implements RopRequestContext {
    ...
    public Session getSession() {
        if (session == null && ropContext != null &&
                ropContext.getSessionManager() != null && getAccessToken() != null) {
           session = ropContext.getSessionManager().getSession(getAccessToken());
        }
        return session;
    }
    ...
    public void removeSession() {
        if (ropContext != null && ropContext.getSessionManager() != null) {
            ropContext.getSessionManager().removeSession(getAccessToken());
        }
    }
